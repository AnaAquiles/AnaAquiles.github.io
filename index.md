...
Here you'll find both halves of that: the academic — 📚 [Publications](/papers/), projects, the record of what I've built and studied (📄 [scientific side](/sci-side/)) — and the wandering one, where I write essays on science, philosophy, and whatever else refuses to stay in its lane, comming soon: [Blog](/left-outparts/). Written whenever time allows itself to be caught.
