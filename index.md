...
[my scientific side](/cv/) — and the wandering one, where I write essays on science, philosophy, and whatever else refuses to stay in its lane, coming soon in my Blog [Left-outparts](/Left-outparts/). Written whenever time allows itself to be caught.
